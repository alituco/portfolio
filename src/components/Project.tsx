    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href="http://www.manzil.bh" target="_blank" rel="noreferrer"><img src={bahrainProperties}  className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="http://www.manzil.bh" target="_blank" rel="noreferrer"><h2>  Pioneering Real Estate Mapping and Valuation System in Bahrain: </h2></a>
                <p>I built Bahrain’s first interactive property map and valuation tool. It plots cadastral parcels on a live map, auto-generates parcel/land graphics (saving agents hours of manual work), and produces model-based price estimates. The stack is Node.js + PostgreSQL/PostGIS with a GraphQL API; mapping uses Mapbox/ArcGIS. A lightweight ML service ranks comparables and explains the main drivers. On top of the map, there’s a management system with analytics, price/rent trends, heatmaps, time-on-market, and portfolio KPIs. </p>
            </div>
            <div className="project">
